 ...
 * @version:  V1.0 
 */
public class HemLowhActivity extends BaseActivity implements OnClickListener{
	/** 应用程序全局属性 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hemlow);
		// 拿到application对象
	...
	public void onClick(View v) {
		...
		//保存成功返回设置中心
			...
			Intent intent = new Intent(HemLowhActivity.this, SetActivity.class);  
			Bundle bundle = new Bundle();
			bundle.putString("msg4", set_name.getText().toString());
