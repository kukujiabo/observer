 ...
 * @version:  V1.0 
 */
public class HemHighActivity extends BaseActivity implements OnClickListener{
	/** 应用程序全局属性 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hemhigh);
		// 拿到application对象
	...
	public void onClick(View v) {
		...
		//保存成功返回设置中心
			...
			Intent intent = new Intent(HemHighActivity.this, SetActivity.class);  
			Bundle bundle = new Bundle();
			bundle.putString("msg3", set_name.getText().toString());
