 ...
 * @version:  V1.0 
 */
public class VersionUpdateActivity extends BaseActivity implements OnClickListener,OnItemClickListener{
	...
	public void onClick(View v) {
		if (v == menu) {
			// 侧滑菜单
			Toast.makeText(VersionUpdateActivity.this, "侧滑菜单:", Toast.LENGTH_LONG).show();
		}
		if (v == warning) {
			// 警告页面
