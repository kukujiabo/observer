 ...
 * @version:  V1.0 
 */
public class VersionIntroducedActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		if (v == menu) {
			// 侧滑菜单
			Toast.makeText(VersionIntroducedActivity.this, "侧滑菜单:", Toast.LENGTH_LONG)
					.show();
		} else if (v == warning) {
			// 警告页面
			startActivity(new Intent(VersionIntroducedActivity.this,
