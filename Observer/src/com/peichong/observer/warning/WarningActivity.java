 ...
 * @version:  V1.0 
 */
public class WarningActivity extends BaseActivity implements OnClickListener,OnItemClickListener{
	...
	public void onClick(View v) {
		if (v == menu) {
			// 侧滑菜单
			Toast.makeText(WarningActivity.this, "侧滑菜单:", Toast.LENGTH_LONG).show();
